    ...
    this.client.payment.payment = {
      ...
      creditCard: {
        ...
        installment: {
          ...
          value: parseFloat(this.client.params.amount.total / this.client.params.installments_number).toFixed(2)
        },
        holder: {
          ...
          birthDate: `${this.client.params.buyer.birth_date.day}/${this.client.params.buyer.birth_date.month}/${this.client.params.buyer.birth_date.year}`,
          phone: {
